    ...
    <>
      ...
      <div className="flex-1 overflow-y-auto">
        {created ? (
          <div className="px-6 py-6 flex flex-col items-center gap-4">
            ...
            <div className="flex flex-col items-center gap-3 w-full">
              ...
              <button
                ...
                className="flex items-center gap-2 bg-[#4a6741] hover:bg-[#3a5333] text-white text-sm font-semibold px-5 py-2.5 rounded-xl transition shadow-sm cursor-pointer"
              >
                <IoDownloadOutline />
                Download QR
              </button>
          ...
          <form id="register-form" onSubmit={onRegisterSubmit} className="px-6 py-5 space-y-5">
            {apiError && (
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <Field label="Password" required type="password" name="password" value={form.password} onChange={onChange} placeholder="Min. 6 chars" icon={<IoLockClosedOutline />} error={errors.password} />
                <Field label="Confirm Password" required type="password" name="confirmPassword" value={form.confirmPassword} onChange={onChange} placeholder="Repeat" icon={<IoLockClosedOutline />} error={errors.confirmPassword} />
              </div>
            </div>
          </form>
        )}
      ...
      <div className="flex-shrink-0 px-6 py-4 border-t border-gray-100 flex gap-3">
        {created ? (
          <>
            ...
            <button
              onClick={onClose}
              className="flex-1 border border-gray-200 hover:border-[#4a6741]/40 text-gray-600 hover:text-[#4a6741] text-sm font-medium py-2.5 rounded-xl transition cursor-pointer"
            >
              Done
            </button>
          </>
          ...
          <>
            ...
            <button
              type="button"
              onClick={onClose}
              className="px-4 border border-gray-200 hover:border-gray-300 text-gray-500 text-sm font-medium py-2.5 rounded-xl transition cursor-pointer"
            >
              Cancel
            </button>
          </>
